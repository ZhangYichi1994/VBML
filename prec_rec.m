% Revised by hkk
function [AUROC,AUPR,prec, tpr, fpr, thresh] = prec_rec(score, target, varargin)
...
if (plot_pr || plot_roc)
 ...
 xlabel('Recall','FontSize',12,'fontweight','bold','fontname','TIMES NEW ROMAN');
 ylabel('Precision','FontSize',12,'fontweight','bold','fontname','TIMES NEW ROMAN');
 title('Precision-Recall Graph','FontSize',14,'fontweight','bold','fontname','TIMES NEW ROMAN');
 end
 if (plot_roc)
 if (plot_pr)
 subplot(1,2,2);
 ...
 xlabel('False Positive Rate','FontSize',12,'fontweight','bold','fontname','TIMES NEW ROMAN');
 ylabel('True Positive Rate','FontSize',12,'fontweight','bold','fontname','TIMES NEW ROMAN');
 title('ROC Graph','FontSize',14,'fontweight','bold','fontname','TIMES NEW ROMAN');
 axis([0 1 0 1]);
 if (plot_roc && plot_pr)
 % double the width
 rect = get(gcf,'pos');
